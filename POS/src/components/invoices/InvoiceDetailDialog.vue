	...
	>
		...
		<template #actions>
			<div class="flex justify-between items-center w-full">
				...
				<Button @click="handlePrint" v-if="settingsStore.allowPrintPreviousInvoices || (settingsStore.allowPrintLastInvoice && invoiceData && invoiceData.name && invoiceData.name === uiStore.lastInvoiceName)">
					<template #prefix>
...
function handlePrint() {
	...
	const isLastInvoice = invoiceData.value.name && uiStore.lastInvoiceName && invoiceData.value.name === uiStore.lastInvoiceName
