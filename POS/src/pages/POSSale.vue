<template>
	<div
		class="flex flex-row bg-gray-50 overflow-hidden"
	...
	>
		...
		<!-- Main App -->
		<template v-else>
			<!-- Icon-Only Management Slider - Always Visible on Desktop (full height) -->
			<ManagementSlider
...
async function handlePaymentCompleted(paymentData) {
	try {
		...
		if (offlineStore.isOffline) {
			...
			uiStore.lastInvoiceName = offlineReceiptName;
			uiStore.showPaymentDialog = false;
			cartStore.clearCart();
